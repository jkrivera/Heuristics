...
for ins in range(1,2):
    ...
    for w1 in range(1):
        for w2 in range(1):
                ...
                Z = mod.addVars(P+1, vtype=GRB.CONTINUOUS, name="Z")
                ...
                mod.addConstr(Z[3] == quicksum(X[j] for j in range(N)), name="Z3")
                    
                name = "R3"
                mod.addConstr(Y == quicksum(X[j] for j in range(N)), name=name)
            
                name = "Z1"
                mod.addConstr(Z[1] >= w[0]*(28384-23726)+23726, name=name)
                print(w[0]*(28384-23726)+23726)
            
                name = "Z2"
                mod.addConstr(Z[2] >= w[1]*(10688-7224)+7224, name=name)
                print(w[1]*(10688-7224)+7224)
            
                mod.setObjective(Z[3], GRB.MAXIMIZE)
            ...
            #        print("Z[",p,"] = ", Z[p].X)
            #    print("")
                print(w,Z[0].X,Z[1].X,Z[2].X,Z[3].X)
