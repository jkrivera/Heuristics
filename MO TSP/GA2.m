function [RK,P,f]=GA2(n,d,npop,ngen)
...
for g=1:ngen
    ...
    r=ranking(f,2*npop);
    [RK,P,f,r]=Actualizacion2(RK,P,f,2*npop,r,npop);
    
    RK = [RK;zeros(10,1) rand(10,n-1)];
    [~, Pp] = sort(RK(npop-9:end,:)');
    P(npop-9:npop,1:end-1)=Pp';
    P(:,end)=P(:,1);
    f=objectives(P,n,d,npop);
    r=ranking(f,npop);
