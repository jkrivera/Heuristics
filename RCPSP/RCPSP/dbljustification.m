function [dbljustified dblfbi_inicio]=dbljustification(soluciones, Prec, nprec, duraciones, rec, cantidadRecursos, nrec, nt, inicio)
...
[x orden]=sort(fbi_inicio);

[dbljustified dblfbi_inicio]=makespan(orden, PrecFBI, nprecFBI, duraciones(nt:-1:1,:), rec(:,nt:-1:1), cantidadRecursos, nrec, nt);
